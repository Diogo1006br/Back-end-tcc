...
class FormsTestCase(TestCase):
    ...
    def test_simple_form_creation(self):
        """Testa a criação simples de um formulário."""
        form = Form.objects.create(
            name="Formulário Simples",
            form={"field": "valor"},
            company=self.company
        )
        self.assertEqual(form.name, "Formulário Simples")
        self.assertEqual(form.company, self.company)

    def test_simple_form_update(self):
        """Testa a atualização simples de um formulário."""
        self.form.name = "Formulário Atualizado Simples"
        self.form.save()
        self.form.refresh_from_db()
        self.assertEqual(self.form.name, "Formulário Atualizado Simples")